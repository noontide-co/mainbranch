...
| Codex CLI | First-class owner loop | Fresh business repos include `AGENTS.md`; the Main Branch Codex plugin installs globally once per user and provides generated Codex guidance. `mb workflow list --runtime codex` exposes supported, pending, and unsupported workflow surfaces. |
