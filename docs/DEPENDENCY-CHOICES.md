...
| 2026-05-04 | Social scheduling | Postiz | Planned optional provider | Social scheduling is useful, but it should be a clear Ship rail rather than a hidden automation dependency. | Keep Postiz behind `mb connect` metadata until scheduling/publishing flows have docs and smoke evidence. |  |
