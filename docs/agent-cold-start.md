...
| Ad creative production, source bites, playbook routing, image review boards, or Facebook image-ad generation | `decisions/2026-05-13-ad-creative-readiness-playbooks-and-review-board.md`, `decisions/2026-05-13-creative-media-generation-rails.md`, `.claude/skills/mb-ads/SKILL.md`, and `.claude/skills/mb-ads/references/image-generation-workflow.md` |
...
| Shared workflow source, generated runtime shells, or drift checks | relevant `workflows/<name>/workflow.md`, generated shell snapshots or fixtures, `docs/compatibility.md`, and nearby workflow validation tests |
