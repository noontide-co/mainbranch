...
installed/latest versions when present. For recommended updates, say Main Branch
is in active transition and the update is a stability boost for routing,
repairs, and skills when release highlights are unavailable, then ask whether to
update now. Do not show ranked actions until after the operator updates or
explicitly chooses to continue. For required updates, route to the cited
