...
def instructions_status(repo: str | Path) -> dict[str, Any]:
    ...
    expected_version_marker = f"This guidance was generated by Main Branch `{__version__}`."
    generated_version_ok = bool(exists and expected_version_marker in text)
    ...
    current = bool(fact_grounding_ok and generated_version_ok and not repo_local_plugin_paths)
    return {
        "ok": current,
        "exists": exists,
        "current": current,
        ...
        "generated_version_ok": generated_version_ok,
