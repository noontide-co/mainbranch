...
def test_doctor_repair_plan_reports_stale_codex_generated_version(
    tmp_path: Path,
) -> None:
    repo = tmp_path / "biz"
    init_run(path=str(repo), name="Acme")
    ...
    agents.write_text(
        agents.read_text(encoding="utf-8").replace(
            "This guidance was generated by Main Branch",
            "This guidance was generated by Main Branch `0.0.0`; stale copy from",
            1,
        ),
        encoding="utf-8",
    )
    ...
    assert "This guidance was generated by Main Branch" in agents_check["expected_version_marker"]
    actions = {action["id"]: action for action in payload["actions"]}
    assert "codex-agents-md" in actions
