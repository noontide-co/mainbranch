...
1. [Hook](#1-hook)
2. [Epiphany Bridge](#2-epiphany-bridge)
3. [Peek the Plan](#3-peek-the-plan)
4. [Features/Benefits + Soft CTA](#4-features-benefits-soft-cta)
5. [The Plan](#5-the-plan)
6. [Answer Questions](#6-answer-questions)
7. [Stack Social Proof](#7-stack-social-proof)
8. [Change Tone](#8-change-tone)
9. [Zoom Out](#9-zoom-out)
10. [Price Anchor](#10-price-anchor)
11. [Low Effort/High Reward](#11-low-effort-high-reward)
12. [Recap Obstacles](#12-recap-obstacles)
13. [Address Objections](#13-address-objections)
14. [Roadmap](#14-roadmap)
15. [Worst vs Best Case](#15-worst-vs-best-case)
16. [First Hard CTA](#16-first-hard-cta)
17. [Risk Reversal](#17-risk-reversal)
18. [Final CTA](#18-final-cta)

---

## 1. Hook

**Objective**: Grab attention immediately by addressing specific pain or desire.

**Guidance**:
- Start with a bang: startling fact, provocative question, or bold statement
- Address internal pains (personal struggles) and circumstantial pains (external situations)
- First 15-20 seconds must make strong impact
- Make viewer think "that's exactly how I feel"

**Template**:
```
Do you ever feel like [specific pain point]? You're watching others [achieve desired outcome], and you wonder, '[Frustrated question]?' If this sounds familiar, you're not alone.
```
...
**Objective**: Build trust by sharing your journey from struggle to solution.
...
## 4. Features/Benefits + Soft CTA

**Objective**: Get first "yes" by highlighting benefits and asking a soft question.

**Guidance**:
- Keep feature mentions brief
- Pose a question that encourages agreement
- Tie action to positive transformation
- Gentle ask, not hard sell

**Template**:
```
So, let me ask you a question: If you had [benefits], would that be helpful to you?
```

**Example**:
```
So, let me ask you a question: If you had step-by-step instructions to take you from noob to profit with ads, live calls to answer all your questions, and access to the best strategies, templates, and frameworks to grow your group, would that be helpful to you?
```
...
**Objective**: Set agenda for what's coming next and introduce common questions.

**Guidance**:
- Introduce FAQs viewers might have
- Let them know you'll address these
- Build anticipation to keep watching

**Template**:
```
And I know that you might be wondering, '[List common questions].' Great questions. Let me break it down for you.
```

**Example**:
```
And I know that you might be wondering, 'Do I need to be ready to run ads to join this group? Why even run ads? Do I need a big budget?' Great questions. Let me break it down for you.
```
...
**Objective**: Address common questions to alleviate doubts.
...
## 7. Stack Social Proof

**Objective**: Build credibility with diverse testimonials and success stories.
...
**Template**:
```
Like [Name], who [achieved result]. Then there's [Name], who [another success].
```
...
**Objective**: Shift tone to recapture attention and emphasize important points.
...
**Template**:
```
Your [goal] will benefit from [solution]. How am I so sure? Because we are consistently seeing [evidence]. Now, imagine if that was you.
```
...
**Objective**: Provide broader context using relatable analogies.

**Guidance**:
- Use relevant analogies to familiar concepts
- Connect to high status or desirable outcomes
- Simplify understanding of complex ideas

**Template**:
```
Think of [your solution] like [analogy]. Instead of [old way], [new way]. That's why [solution] is so powerful—it helps you [benefit].
```

**Example**:
```
Running ads is like using a magnet. You don't have to chase people; the right ads pull in the right audience. The stronger the magnet, the more people it attracts. The cool thing about magnets is that they only attract what's compatible—just like ads. You won't have to worry about bringing in the wrong people.

Instead of spending time searching for the right members, the ads do the work for you. They bring in people who fit your group and are ready to join. That's why ads are so powerful—they help you grow your community with the right members.
```
...
**Objective**: Set perceived value high before revealing your offer.
...
## 11. Low Effort/High Reward

**Objective**: Emphasize ease of starting and significant benefits.

**Guidance**:
- Transition smoothly to the pitch
- Explain why it's fast and easy with reasons
- Use analogies to alleviate fear of complexity
...
**Objective**: Remind them of barriers and how your solution removes them.

**Guidance**:
- Elicit another soft yes
- List challenges they face
- Show understanding and relatability

**Template**:
```
Sounds interesting? Great. [Solution] removes the biggest obstacles that stop most people from [achieving goal]. You don't need [obstacle 1], [obstacle 2], or [obstacle 3].
```
...
**Objective**: Tackle remaining questions and reassure them.
...
**Template**:
```
You might be asking, '[Question]?' Don't worry—you'll [reassurance].
```
...
**Objective**: Outline steps they'll take after joining.

**Guidance**:
- Explain the process briefly
- Focus on benefits gained
- Keep it concise — avoid unnecessary details

**Template**:
```
So, what happens if you sign up right now? You'll [step 1], [step 2], and [benefit].
```

**Example**:
```
So, what happens if you sign up right now? You'll follow a simple plan to start running ads and growing your Skool group. We'll show you everything step by step so you can bring in new members without needing a big budget or a lot of time.
```

---

## 15. Worst vs Best Case

**Objective**: Show little to lose, much to gain.

**Guidance**:
- Present minimal worst case risk
- Paint significant best case positive change
- Add relatability with examples
- Pose question leading to agreement

**Template**:
```
Worst case? You [minimal loss]. Best case? You [significant gain]. And maybe you're not looking to [extreme outcome], but would [moderate benefit] make a difference for you?
```
...
**Objective**: Encourage immediate action by emphasizing cost of inaction.

**Guidance**:
- Highlight consequences of not acting
- Reiterate the dream outcome
- Include direct call to action
- Show commitment from your side

**Template**:
```
The only thing that's certain is that if you don't [take action], nothing will change. But if you do, you could be the next one [achieving goal]. [Statement of commitment]. So, are you ready to take that step?
```
...
**Objective**: Compelling last appeal to motivate action.

**Guidance**:
- Simple, direct instruction
- Create momentum toward click/signup

**Template**:
```
So, click the button below to [action], and we'll see you on the other side!
```

**Example**:
```
So, click the button below to join, and we'll see you on the other side!
```
...
### Energy and Presence
- Your emotional state transfers to viewer — start strong
- First 5 seconds are critical
- Believe in what you're saying; let conviction show

### Natural Delivery
- Don't just read — memorize each section before delivering
- Flow with commas, not full stops (think: one long sentence with pauses)
- Each section should be one clean take

### Observer Checklist
Have someone watch for:
- Energy level (especially first 5 seconds)
- Pacing and flow (natural vs robotic)
- Conviction and confidence
- Natural vs scripted feeling

### Production Quality
- Camera: Professional quality, frame yourself so eyeline is on top third
- Audio: Clear, crisp microphone
- Lighting: Soft light, no harsh shadows
- Background: Clean, intentional, distraction-free
- Teleprompter: Position across camera lens direction

### Time Investment
Expect 30 minutes to 4 hours for shooting depending on complexity and takes needed.
