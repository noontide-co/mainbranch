...
```
User: /mb-organic video "how I structure my morning routine"
...
```
User: /mb-organic mine

Claude: Mining is research work now — it lives in `/mb-think` so your mined
concepts go to `research/` and can feed your reference files.

Switching you to `/mb-think` for mining. Once you've got concepts, come back
to `/mb-organic` to generate scripts from them.
...
When conversations get long, Claude's memory compresses. If mid-/mb-organic and this happens:

**For the user:** Just type `/mb-organic` again and describe where you were:
