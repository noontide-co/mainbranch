...
Use `/mb-think` to mine competitors before generating:

```
/mb-think
```

Tell Claude you want to research competitor content. This extracts winning concepts and saves them to `research/`. Then run `/mb-organic` to generate from those concepts.

### Option B: Generate immediately

```
/mb-organic video "your topic here"
```
...
1. Run `/mb-organic` to start the full generation flow
2. Or run `/mb-organic video "topic"` to generate immediately
