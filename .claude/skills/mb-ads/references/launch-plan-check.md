...
run, route through the `playbooks/google-ads-search-launch/playbook.md` source
or the `.claude/playbooks/google-ads-search-launch/` Claude shell and
instantiate its push-playbook template.
