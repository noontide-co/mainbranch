...
| Where does proof go? | Company-wide proof goes in `core/proof/`. Offer-specific proof goes in `core/offers/[name]/proof/`. Older offer testimonial files can be read as legacy context, but new proof should use the proof folders. |
