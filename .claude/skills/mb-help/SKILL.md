...
| How do I get a daily read on the business? | `mb pulse init` scaffolds deterministic collectors + a repo-local pulse skill that writes one short daily paper with exactly one recommended action. See [cli-surfaces.md](references/cli-surfaces.md). |
