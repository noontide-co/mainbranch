...
**Power user tip:** You can add extra directories with `/add-dir`. The standard workflow is still: start in your business repo and run `/mb-start`.
...
Ready to get started? Follow the commands above. Once Claude is running, type `/mb-start` and it'll guide you from there.
