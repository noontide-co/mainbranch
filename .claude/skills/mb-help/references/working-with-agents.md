...
**Multi-source research** (`/mb-think`)
...
**Compliance review** (`/mb-ads review`)
...
- Re-invoke skills (`/mb-think`, `/mb-ads`) after compaction to reload context
- Break long sessions by topic — finish one research thread before starting another
- Use `/mb-start` to begin fresh sessions when context is heavy
...
|-------|----------------|
| `/mb-think` | Multi-source research (YouTube + web + X simultaneously) |
| `/mb-ads review` | 6 compliance lenses in parallel |
| `/mb-help` | This page (you're reading it now) |
