...
name: think
description: |
  Combined research and decision workflow. Use when exploring topics, making decisions, or documenting choices. Supports modes: full flow, research-only, decide-only, codify.
---
