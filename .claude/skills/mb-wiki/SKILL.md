...
**Steps:**
1. Read config: `cat ~/.mainbranch/mb-wiki.json | jq -r '.wiki_repo'`
...
**Steps:**
1. Read config: `cat ~/.mainbranch/mb-wiki.json`
...
- [references/pull-engine-updates.md](references/pull-engine-updates.md) — Standard Main Branch update check
