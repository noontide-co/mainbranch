...
### proof placement
> "Proof goes where it can be reused safely. Company-wide proof belongs in `core/proof/`. Proof that only supports one specific offer belongs in `core/offers/[name]/proof/`."
