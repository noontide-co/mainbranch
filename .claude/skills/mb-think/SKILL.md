...
| `core/offers/` exists | Multi-offer repo. Check active offer from status JSON facts, with `.vip/local.yaml` only as a legacy fallback. If not set, ask which offer this research/decision is about. |
