...
```
/mb-think deep research on a simple topic
```
...
Gemini Deep Research is now available in /mb-think.
...
- `mb-setup/SKILL.md` Step 4a — How env.sh is created during initial setup
