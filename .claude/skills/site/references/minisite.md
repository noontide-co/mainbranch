...
The minisite is one of three site shapes `/site` supports — see [`graduation.md`](graduation.md) for the full ladder (lander → minisite → website → website + CMS).
...
**Implementation:**
- [`/site` SKILL.md](../SKILL.md) — the skill that triages site shapes and routes to minisite-build.md
