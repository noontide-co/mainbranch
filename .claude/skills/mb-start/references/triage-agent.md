...
| `current_offer` | From status JSON facts, with `.vip/local.yaml` as legacy fallback | 1 line | All 3 agents |
...
[current_offer from status JSON facts, legacy fallback, or "single-offer mode"]
